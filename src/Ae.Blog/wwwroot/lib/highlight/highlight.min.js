...
;hljs.registerLanguage("csharp",e)})();/*! `groovy` grammar compiled for Highlight.js 11.9.0 */
...
;hljs.registerLanguage("python",e)})();/*! `xml` grammar compiled for Highlight.js 11.9.0 */
(()=>{var e=(()=>{"use strict";return e=>{
